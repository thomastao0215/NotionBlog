...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '0f3443b6ed194cf280be2ce0fe84fc3c,en:7c1d570661754c8fbc568e00a01fd70e',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'FOMO 小法师', // 您的昵称 例如 
  BIO: process.env.NEXT_PUBLIC_BIO || 'Web3 DeFi 研究员/开发者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://fomowizard.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'fomowizard@gmail.com', // 邮箱地址 例如mail@tangly1024.com
